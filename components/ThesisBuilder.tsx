                ...
                {setupStep === 0 && (
                    <div className="text-center py-8">
                        <div className="flex justify-between items-center mb-6 w-full px-4">
                            <button onClick={() => setView('list')} className="text-gray-500 hover:text-blue-600 flex items-center text-sm font-bold">
